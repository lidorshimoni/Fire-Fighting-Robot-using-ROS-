...
![Costmap Visualization](else/rviz_costmap_image.png "Costmap Visualization"=250x250)

![simulation workspace](else/gazebo_image.png "simulation workspace"=250x250)
